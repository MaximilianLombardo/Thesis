...
params:
  ge.txt: "C:\Thesis\data\SNF\GBM\GLIO_Gene_Expression.txt"
  mirna.txt: "C:\Thesis\data\SNF\GBM\GLIO_Mirna_Expression.txt"
  meth.txt: "C:\Thesis\data\SNF\GBM\GLIO_Methy_Expression.txt"
  survival.txt: "C:\Thesis\data\SNF\GBM\GLIO_Methy_Expression.txt"
...
chooseDataType <- function(disease){
  ...
  if(disease == "GBM"){
    params$ge.txt <- "C:/Thesis/data/SNF/GBM/GLIO_Gene_Expression.txt"
    params$mirna.txt <- "C:/Thesis/data/SNF/GBM/GLIO_Mirna_Expression.txt"
    params$meth.txt <- "C:/Thesis/data/SNF/GBM/GLIO_Methy_Expression.txt"
    params$survival.txt <- "C:/Thesis/data/SNF/GBM/GLIO_Survival.txt"
  }else if(disease == "BREAST"){
    params$ge.txt <- "C:/Thesis/data/SNF/Breast/BREAST_Gene_Expression.txt"
    params$mirna.txt <- "C:/Thesis/data/SNF/Breast/BREAST_Mirna_Expression.txt"
    params$meth.txt <- "C:/Thesis/data/SNF/Breast/BREAST_Methy_Expression.txt"
    params$survival.txt <- "C:/Thesis/data/SNF/Breast/BREAST_Survival.txt"
  }else if(disease == "COLON"){
    params$ge.txt <- "C:/Thesis/data/SNF/Colon/COLON_Gene_Expression.txt"
    params$mirna.txt <- "C:/Thesis/data/SNF/Colon/COLON_Mirna_Expression.txt"
    params$meth.txt <- "C:/Thesis/data/SNF/Colon/COLON_Methy_Expression.txt"
    params$survival.txt <- "C:/Thesis/data/SNF/Colon/COLON_Survival.txt"
  }else if (disease == "KIDNEY"){
    params$ge.txt <- "C:/Thesis/data/SNF/Kidney/KIDNEY_Gene_Expression.txt"
    params$mirna.txt <- "C:/Thesis/data/SNF/Kidney/KIDNEY_Mirna_Expression.txt"
    params$meth.txt <- "C:/Thesis/data/SNF/Kidney/KIDNEY_Methy_Expression.txt"
    params$survival.txt <- "C:/Thesis/data/SNF/Kidney/KIDNEY_Survival.txt"
  }else if(disease == "LUNG"){
    params$ge.txt <- "C:/Thesis/data/SNF/Lung/LUNG_Gene_Expression.txt"
    params$mirna.txt <- "C:/Thesis/data/SNF/Lung/LUNG_Mirna_Expression.txt"
    params$meth.txt <- "C:/Thesis/data/SNF/Lung/LUNG_Methy_Expression.txt"
    params$survival.txt <- "C:/Thesis/data/SNF/Lung/LUNG_Survival.txt"
  }else{
...
#Function for actually computing the kernel matrix
...
#return.best.kernel <- function(data, target.kernel){
#  kernels <- generate.kernels(data)
#  best.kernel <- return.best.kernel(kernels, target.kernel)
#  return(best.kernel)
#}

ge.kernels <- generate.kernels(ge)
ge.kern <- return.best.kernel(ge.kernels, survival.similarity)
ge.kern.kl <- as.kernelMatrix(ge.kern)

mirna.kernels <- generate.kernels(mirna)
mirna.kern <- return.best.kernel(mirna.kernels, survival.similarity)
mirna.kern.kl <- as.kernelMatrix(mirna.kern)

meth.kernels <- generate.kernels(meth)
meth.kern <- return.best.kernel(meth.kernels, survival.similarity)
meth.kern.kl <- as.kernelMatrix(meth.kern)
```
