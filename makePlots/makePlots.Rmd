...
noise.sim <- simulateNoisyData(gaussian.noise = 1, gamma.noise = 2)
...
a.nmi <- plotSNFHeatComparison(Data1 = inverted.sim$classes,
                               Data2 = inverted.sim$inverted.classes,
                               truelabel = inverted.sim$true.label)

#Scenario B - Noisy views
b.nmi <- plotSNFHeatComparison(Data1 = noise.sim$gaussian.noise,
