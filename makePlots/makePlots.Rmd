...
#file.path <- "~/Documents/uva/master/the/utils/simMVData.R" 
...
```{r}
#Figure 4 - K means multiple kernel learning as implemented by Mehmet Gonen
source.path <- "~/Documents/gitRepos/master/lmkkmeans-master"


e.nmi <- plotMKLKMHeatComparison(Data1 = noise.sim$gaussian.noise,
                               Data2 = noise.sim$gamma.noise,
                               truelabel = noise.sim$true.label)
```
